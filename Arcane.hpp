...
#define Arcane_h
#pragma once
static const vector<string> Arcane_Cantrips = {"Arcane Slash", "Ancient Dust", "Bullhorn", "Chill Touch", "Dancing Lights", "Dancing Lights", "Daze", "Detect Magic",
...
static const vector<string> Arcane_1st_Level = {"Acidic Burst","Admonishing Ray", "Agitate", "Airburst", "Alarm","Animate Dead", "Animate Rope", "Ant Haul", "Anticpate Peril",
...
static const vector<string> Arcane_2nd_Level = {"Acid Arrow", "Animated Assualt", "Ash Cloud", "Befitting Attire", "Blood Duplicate", "Blood Vendetta", "Blur", "bone Spray",
...
static const vector<string>  Arcane_3rd_Level = {"Agonizing Despair", "Aqueous Orb", "Bind Undead", "Blazing Dive", "Blindess", "Bottomless Stomach", "Bracing Tendrals",
...
static const vector<string>  Arcane_4th_Level = {"Aerial Form", "Aromatic Lure", "Bestial Curse", "Blink", "Call the Blood", "Chromatic Armor", "Chromatic Ray", "Clairvoyance",
...
static const vector<string>  Arcane_5th_Level = {"Acid Storm", "Bandits Doom", "Banishment", "Belittling Boast", "Black Tentacles", "Blazing Fissure", "Blinding Foam", "Blink Charge", "Blister",
...
static const vector<string>  Arcane_6th_Level = {"Aura of the Unremarkable", "Awaken Entropy", "Baleful Polymorph", "Bound in Death", "Cast into Time", "Catch your Name", "Chain Lightning",
...
static const vector<string>  Arcane_7th_Level = {"Blightburn Blast", "Contingency", "Control Sand", "Corrosive Body","Dimensional Lock","Duplicate Foe","Eclipse Burst","Energy Aegis",
...
static const vector<string>  Arcane_8th_Level = {"All is One, One is All", "Antimagic Field", "Boil Blood", "Burning Blossoms", "Deluge", "Disappearance", "Discern Location", "Dream Council",
...
static const vector<string>  Arcane_9th_Level = {"Astral Labrynth", "Bilocation", "Disjunction", "Divinity Leech","Foresight","Implosion", "Linnorm Sting", "Massacre", "Meteor Swarm",
...
static const vector<string>  Arcane_10th_Level = {"Cataclysm", "Fated Confrontation", "Gate", "Indestructibility","Nullify", "Remake","Shadow Army","Time Stop","Wish"};
