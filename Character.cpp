...
#define PrintSpellSlots(T) if(NPC->InnateCaster){fprintf(f,"[%d slots]: ",GetElement(InnateSpellSlotsByLevel(NPC->Level*(NPC->Class == Magic_User)+NPC->Level/3*(NPC->Class != Magic_User)), T));} else{fprintf(f,": ");}
