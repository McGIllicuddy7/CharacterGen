...
#define Divine_h
#pragma once
const char * Divine_Cantrips[] = {"Ancient Dust", "Approximate", "Bullhorn", "Chill Touch", "Daze", "Detect Magic", "Disrupt Undead", "Divine Lance", "Forbidding Ward",
...
"Shield", "Sigil", "Stabilize", "Summon Instrument", "Torturous Tramua", "Wash Your Luck", 0};

const char * Divine_1st_Level[] = {"Admonishing Ray", "Air Bubble", "Alarm", "Animate Dead", "Bane", "Bless", "Breadcrumbs", "Celestial Accord", "Command",
...
"Synchronize","Thoughtful Gift", "Ventriloquism", 0};

const char * Divine_2nd_Level[] = {"Advanced Scurvy","Augury", "Blazing Blade", "Blood Vendetta", "Bone Spray", "Boneshaker", "Bralani Referendum",
...
"Swallow Light", "Undetectable Alignment", "Vicious Jealousy", "Warriors Regret", "Water Breathing", "Water Walk", 0};

const char * Divine_3rd_Level[] = {"Agonizing Despair", "Behold the Weave", "Bind Undead", "Blindness","Casters Imposition", "Chilling Darkness","Circle of Protection",
...
"Whirling Scarves", "Zone of true",0};

const char * Divine_4th_Level[] = {"Air Walk", "Anathematic Reprisal", "Bloodspray Curse", "Cloak of Light", "Compel True Name", "Dawnflowers Light", "Detect Creator",
...
"Spiritual Attunement", "Talking Corse", "Vampiric Maiden", "Vital Beacon",0};

const char * Divine_5th_Level[] = {"Abyssal Plane", "Bandits Doom", "Banishment", "Belittling Boast", "Blackfingers Blades", "Blessing of Defiance", "Blink Charge",
...
"Temporary Glyph", "Tongues", "Wall of Flesh", 0};

const char * Divine_6th_Level[] = {"Awaken Entropy", "Blade Barrier", "Blinding Fury", "Bound in Death", "Catch Your Name", "Daemon Form", "Demon Form", "Devil Form",
...
"Spirit Blast", "Stone Tell", "Stone to Flesh", "Suffocate", "Suspended Retribution", "Temporal Ward", "True Seeing", "Vampiric Exsanguination", "Zealous Conviction",0};

const char * Divine_7th_Level[] = {"Angel Form", "Cosmic Form", "Deity's Strike", "Dimensional Lock", "Divine Decree", "Divine Vessel", "Eclipse Burst", "Energy Aegis", "Etheral Jaunt",
"Finger of Death", "Inexhastible Cynicism", "Moonburst", "Plane Shift", "Regenerate","Return to Essence", "Sunburst","Tempese of Shades",0};

const char * Divine_8th_Level[] = {"Antimagic Field", "Canticle of Everlasting", "Devour Life", "Discern Location", "Divine Armageddon", "Divine Aura", "Divine Inspiration",
"Moment of Renewal", "Spiritual Epidemic", "Summon Deific Herald",0};

const char * Divine_9th_Level[] = {"Astral Labrynth", "Bind Soul", "Crusade", "Foresight", "Massacre", "Overwhelming Presence", "Proliferating Eyes", "Telepathic Demand",
"Undertaker", "Voracoius Gestalt", "Wall of the Banshee", "Weapon of Judgment",0};

const char * Divine_10th_Level[] = {"Avatar", "Fated Confrontation", "Gate", "Indestructability", "Miracle", "Nullify", "Remake", "Revival",0};
