...
#pragma once
const char * Occult_Cantrips[] = {"Approximate", "Bullhorn", "Chill Touch", "Dancing Lights", "Daze", "Detect Magic", "Forbidding Ward", "Ghost Sound", "Guidance",
...
"Warp Step", "Wash Your Luck", 0};

const char * Occult_1st_Level[] = {"Agitate", "Alarm", "Animate Dead", "Anticipate Peril", "Aqueous Blast", "Bane", "Biting Words", "Bless", "Breadcrumns", "Celestial Accord",
...
const char * Occult_2nd_Level[] = {"Animated Assault", "Animus Mine","Augury","Befitting Attire", "Blistering Invective", "Blood Duplicate", "Blood Vendetta", "Blur",
...
"Umbral Mindtheft", "Undetectable Alignment", "Vicious Jealousy", "Vomit Swarm","Warriors Regret", "Worms Repast", 0};

const char * Occult_3rd_Level[] = {"Agonizing Despair","Behold the Weave", "Bind Undead", "Blindness", "Bottomless Stomach", "Bracing Tendrils", "Caster's Imposition",
...
"Vampiric Touch", "Wall of Shadow","Wanderer's Guide", "Web of Eyes","Whirling Scarves","Zone of Truth",0};

const char * Occult_4th_Level[] = {"Aromatic Lure", "Bestial Curse", "Blink", "Bloodspray Curse", "Bursting Bloom", "Call the Blood", "Chroma Leech", "Chromatic Armor",
...
"Suggestion", "Talking Corpse", "Telepathy", "Tortoise and the Hare", "Umbral Graft", "Vampiric Maiden", "Variable Gravity", "Veil","Vision of Beauty", "Winning Streak",0};

const char * Occult_5th_Level[] = {"Abberant Form", "Abyssal Plague", "Bandit's Doom", "Banishment", "Belittling Boast", "Black Tentacles", "Blink Eyese", "Blinding Foam",
...
"Telepathic Bond", "Temporary Glyph", "Tongues", "Wall of Flesh",0};

const char * Occult_6th_Level[] = {"Aura of the Unremarkable", "Awaken Entropy", "Blanket of Stars", "Blinding Fury","Bound in Death", "Cast into Time",
...
"Unexpected Transposition", "Vampiric Exsanguination", "Vibrant Pattern", "Wall of Force","Word of Revision", "Zealous Conviction", "Zero Gravity",0};

const char * Occult_7th_Level[] = {"Blightburn Blast", "Curse of the Spirit Orchestra","Dimensional Lock", "Duplicate Foe", "Energy Aegis", "Ethereal Jaunt", "Force Cage",
...
"True Target", "Visions of Danger", "Warp Mind", 0};

const char * Occult_8th_Level[] = {"Antimagic Field","Canticle of Everlasting Grief","Devour Life","Disaperrance","Discern Location","Dream Council","Falling Sky","Hypnopompic Terrors",
...
"Unrelenting Observation",0};

const char * Occult_9th_Level[] = {"Astral Labyrinth", "Bilocation","Bind Soul", "Divinity Leech", "Foresight","Overwhelming Presence", "Prismatic Shield","Prismatic Sphere",
...
const char * Occult_10th_Level[] = {"Alter Reality","Fabricated Truth","Fated Confrontation","Gate","Indestructibility","Nullify","Remake","Shadow Army","Time Stop",0};
#endif /* Occult_h */
