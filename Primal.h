...
#define Primal_h
#pragma once
const char * Primal_Cantrips[] = {"Acid Splash", "Approximate", "Dancing Lights", "Detect Magic", "Disrupt Undead", "Electric Arc", "Gale Blast", "Gouging Claw", "Guidance",
...
"Read Aura", "Scatter Scree", "Sigil", "Spout", "Stabilize", "Tame", "Tanglefoot", 0};

const char * Primal_1st_Level[] = {"Acidic Burst", "Air Bubble", "Airburst", "Alarm", "Animal Allies", "Ant Haul","Aqueous Blast", "Breadcrumbs", "Briny Bolt",
...
"Tether", "Ventriloquism", "Verdant Sprout","Verminous Lure",0};

const char  *  Primal_2nd_Level[] = {"Acid Arrow", "Advanced Scurvy", "Animal Form", "Animal Messenger", "Ash Cloud", "Barkskin", "Blazing Blade", "Bone Spray" "Boneshaker",
...
const char * Primal_3rd_Level[] = {"Animal Vision", "Aquesous Orb", "Blazing Dive", "Blindness", "Bottomless Stomach", "Caster's Imposition", "Crashing Wave",
...
"Warding Agression", "Web of Eyes",0};

const char * Primal_4th_Level[] = { "Aerial Form", "Air Walk", "Bestial Curse", "Bloodspray Curse", "Bursting Bloom", "Call the Blood", "Cloak of Light","Compel True Name",
...
"Spike Stones", "Stoneskin", "Swarming Wasp Stings", "Tortoise and the Hare", "Vital Beacon", "Wall of Fire", "Weapon Storm",0};

const char * Primal_5th_Level[] = {"Acid Storm","Banishmnent", "Blackfingers Blades", "Blazing Fissure", "Blessing of Defiance", "Blinding Foam", "Blister", "Chameleon Coat",
...
"Temporary Glyph","Transmute Rock and Mud", "Tree Stride","Wall of Flesh","Wall of Ice", "Wall of Stone","Wyvern Sting",0};

const char * Primal_6th_Level[] = {"Baleful Polymorph", "Blanket of Stars", "Blinding Fury", "Catch Your Name", "Chain Lightning", "Dragon Form", "Elemental Confluence",
...
"Scintillating Safegaurd", "Stone Tell", "Stone to Flesh", "Tangling Creepers","True Seeing", 0};

const char * Primal_7th_Level[] = {"Blighburn Blast", "Corrosive Body", "Cosmic  Form", "Eclipse Burst", "Energy Aegis", "Fiery Body", "Finger of Death","Frigid Fury",
"Mask of Terror", "Moonburst", "Plane Shift", "Regenerate", "Sunburst", "Unfettered Pack", "Volcanic Eruption",0};

const char * Primal_8th_Level[] = {"All is One, One is All","Boil Blood", "Burning Blossoms", "Clone Companion", "Deluge", "Earthquake", "Horrid Wilting",
 "Moment of Renewal","Monstrocity Form", "Polar Ray", "Punishing Winds", "Whirlwind","Wind Walk",0};

const char * Primal_9th_Level[] = {"Disjuntion", "Implosion", "Linnorm Sting", "Massacre", "Meteor Swarm", "Nature's Enmity", "One with the Land", "Shapechange",
"Storm of Vengeance", "Upheaval",0};

const char * Primal_10th_Level[] ={"Cataclysm", "Dinosaur Fort", "Element Embodied","Fated Confrontation", "Indestructibility", "Nature Incarnate",
"Nullify", "Primal Herd", "Primal Phenomenon", "Remake", "Reviaval", "Summon Kaiju",0 };
